...
> Status: **design complete, no code yet.** All decisions in §9 are settled; this document is the
> spec for the implementation phase. Projects will live under `src/Shared/Diagnostics.*`.
