...
Infrastructure/ DocumentDbContext, Configurations/, Repositories/,
...
dotnet ef migrations add <Name> `
  -p src/Backend/OCRWeb.Document/OCRWeb.Document.csproj `
  -s src/Backend/OCRWeb.API/OCRWeb.API.csproj `
  --context DocumentDbContext -o Infrastructure/Migrations
```
