...
public class ThemeDetailConfiguration : IEntityTypeConfiguration<ThemeDetail>
{
    public void Configure(EntityTypeBuilder<ThemeDetail> builder)
    {
        ...
        builder.Property(x => x.PropertyLabel).HasColumnName("sPropertyLabel").HasColumnType("varchar(200)").IsRequired();
        builder.Property(x => x.PropertyDescription).HasColumnName("sPropertyDescription").HasColumnType("varchar(500)").IsRequired();
        builder.Property(x => x.PropertyType).HasColumnName("sPropertyType").HasColumnType("varchar(50)").IsRequired();
        builder.Property(x => x.AllowedValues).HasColumnName("sAllowedValues").HasColumnType("varchar(1000)");
        builder.Property(x => x.PropertyValue).HasColumnName("sPropertyValue").HasColumnType("varchar(500)");
